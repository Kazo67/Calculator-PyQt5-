...
# Returns string with symbol at the end if string and symbol passed algorithm
def addSymbolAtTheEndOfLabel(string, symbol):
    numbers = [
        '0', '1', '2',
        '3', '4', '5',
        '6', '7', '8',
...
def deleteLastCharacterOfString(string):
    return string[:-1]

# Returns square root string result of current value in label (eval)
def returnResultOfExtractionOfTheRoot(string):
    numbers = [
        '0', '1', '2',
        '3', '4', '5',
        '6', '7', '8',
...
# Returns string result of current value in label (eval)
def sumTheValue(string):
    numbers = [
        '0', '1', '2',
        '3', '4', '5',
        '6', '7', '8',
...
class AplicationWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        super(AplicationWindow, self).__init__()
    ...
    def mechanism(self):
        ...
        self.deleteOne.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", deleteLastCharacterOfString(self.label.text()))))

        self.point.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "."))))

        self.zero.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "0"))))
        ...
        self.plus.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "+"))))
        self.minus.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "-"))))
        self.multiply.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "*"))))
        self.divide.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "/"))))
        self.to_the_power_of.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "**2"))))
        self.root.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", returnResultOfExtractionOfTheRoot(self.label.text()))))

        self.sum.clicked.connect(lambda: _setLabelText(_translate("Kalkulator", sumTheValue(self.label.text()))))
        ...
        self.shortcutDivide.activated.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "/"))))
        self.shortcutPlus.activated.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "+"))))
        self.shortcutSum.activated.connect(lambda: _setLabelText(_translate("Kalkulator", sumTheValue(self.label.text()))))
        self.shortcutEnter.activated.connect(lambda: _setLabelText(_translate("Kalkulator", sumTheValue(self.label.text()))))
        self.shortcutMinus.activated.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "-"))))
        self.shortcutMultiply.activated.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "*"))))
        self.shortcutPoint.activated.connect(lambda: _setLabelText(_translate("Kalkulator", addSymbolAtTheEndOfLabel(self.label.text(), "."))))
        self.shortcutBackspace.activated.connect(lambda: _setLabelText(_translate("Kalkulator", deleteLastCharacterOfString(self.label.text()))))
